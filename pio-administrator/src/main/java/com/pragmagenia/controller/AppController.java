...
public class AppController {
    ...
    protected static final String VIEW_NAME_NUEVO_SERVIDOR_PAGE = "/nuevo-servidor";
    protected static final String VIEW_NAME_EDIT_COMANDO_PAGE = "/editar-comando";
    protected static final String VIEW_NAME_NUEVO_COMANDO_PAGE = "/nuevo-comando";
